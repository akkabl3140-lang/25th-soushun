...
export function Header() {
  ...
  const menuItems = [
    ...
    { label: '出演者', href: '#performers' },
    { label: 'プログラム', href: '#program' },
    { label: '座席券', href: '#ticket' },
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <a
            ...
            className="text-xl md:text-2xl text-white tracking-wider hover:text-cyan-400 transition-colors duration-300"
          >
            和太鼓「早春の陣」
          </a>
          ...
          <div className="hidden md:flex items-center space-x-8">
            {menuItems.map((item) => (
              <a
                ...
                className="text-white hover:text-cyan-400 transition-colors duration-300 text-sm tracking-wide"
              >
                {item.label}
              </a>
            ))}
